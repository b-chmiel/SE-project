...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/soft_eng/project/0.1.1/client")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/soft_eng/project/0.1.1/client/{clientId}")]
        [ValidateModelState]
        ...
        /// <response code="404">Client not found</response>
        [HttpGet]
        [Route("/soft_eng/project/0.1.1/client/{clientId}/visits")]
        [ValidateModelState]
        ...
        public virtual IActionResult UpdateClient([FromBody]ModelClient body)
        { 
            //TODO: Uncomment the next line to return response 400 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(400);
